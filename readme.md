...
We say that a subset of the population is high value if there is a higher concentration of churned balance relative to customer count. Specifically we will be looking at the ratios

$$
\text{Value of group} = \frac{\text{\% of churned balance attributed to the group}}{\text{\% of population from the group}}
$$
